...
(function (root, factory) {
    ...
    return function ImageZoom(container, opts) {
        ...
        data.zoomedImgOffset = {
            vertical:
                options.offset && options.offset.vertical
        ...
        function onSourceImgLoad() {
            ...
            // else read from the zoomedImg
                ...
                data.zoomLens.width =
                    data.zoomedImg.element.clientWidth / scaleX;
                data.zoomLens.height =
                    data.zoomedImg.element.clientHeight / scaleY;
        ...
        function setup() {
            ...
            // or get sourceImg element from specified container
                ...
                if (data.sourceImg.element.nodeName !== "IMG") {
                    data.sourceImg.element = data.sourceImg.element.querySelector(
                        "img"
                    );
                }
            }
        ...
        function kill() {
            ...
            data.zoomLens.element.removeEventListener(
                "mouseenter",
                events,
                false
            );
